          ...
          <div className="flex flex-col gap-6">
            <div className="flex flex-col sm:flex-row sm:items-center gap-4">
              <div className="relative flex-1 sm:max-w-xs">
                {/* z-10 keeps the icon above the input's backdrop-blur, which
                    otherwise blurs it into a smudge */}
                <span className="pointer-events-none absolute left-4 top-1/2 -translate-y-1/2 z-10 text-white/50">
